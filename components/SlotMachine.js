...
const prizes = [
  ...
  { name: 'Soro de Crescimento Rápido', type: 'ITEM', value: 'fast_growth_serum', weight: 500, icon: '/img/prizes/serum.png' },
  { name: 'Estimulante de Produção', type: 'ITEM', value: 'production_stimulant', weight: 300, icon: '/img/prizes/stimulant.png' },
  { name: 'Kit de Emergência', type: 'ITEM', value: 'emergency_kit', weight: 700, icon: '/img/prizes/emergency_kit.png' },
  { name: 'Chave Mestra do Hospital', type: 'ITEM', value: 'master_hospital_key', weight: 50, icon: '/img/prizes/master_key.png' },
  { name: 'Cápsula do Tempo', type: 'ITEM', value: 'time_capsule', weight: 20, icon: '/img/prizes/capsule.png' },
  { name: '1 NFT RARO', type: 'NFT', value: 'ID_DO_NFT_RARO', weight: 0.00001, icon: '/img/prizes/prize_6.png' },
];
